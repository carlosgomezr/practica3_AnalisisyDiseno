<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Credito.aspx.cs" Inherits="Practica2_AnalisisYDiseño1.Credito" %>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="Credito.aspx">CREDITO</a></li>
    ...
    <section id="title" class="emerald">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h1>DEBITAR</h1>
                    <p>DEBITA DINERO A OTRA CUENTA</p>
        ...
        <div class="container">
            <form id="form1" runat="server" class="center" role="form">
                ...
                <div class="form-group">
                    <asp:Label runat="server" >Cuenta a Acreditar</asp:Label>                                    
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <asp:Label runat="server" >Monto a Acreditar</asp:Label>                                    
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                     <asp:TextBox type="text" id="descripcion" name="descripcion" placeholder="Descripcion" class="form-control" runat="server"></asp:TextBox>                                         
                    ...
                    <asp:Button ID="b_agua" value="1" name="b_ingresar" type="Button" class="btn btn-success btn-md btn-block" runat="server" Text="ACREDITAR" OnClick="b_agua_Click"   />
