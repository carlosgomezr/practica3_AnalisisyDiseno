<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Perfil.aspx.cs" Inherits="Practica2_AnalisisYDiseño1.Perfil1" %>
    ...
    <section id="title" class="emerald">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h1>BIENVENIDO</h1>
                    <p>ESTE ES EL PERFIL DE SU CUENTA</p>
    ...
    <section id="recent-works">
        <div class="container">
            <form id="form1" runat="server" class="center" role="form">
                ...
                <div class="form-group">
                    <asp:Label runat="server" id="nombre" style="color:green" ></asp:Label>
                </div>
                ...
                <div class="form-group">
                   <asp:Label runat="server" id="L_usuario" style="color:green" ></asp:Label>
                </div>
                     <div class="form-group">
                    <asp:Label runat="server" >Correo Electrónico</asp:Label>                                    
                </div>
                <div class="form-group">
                    <asp:Label runat="server" id="L_correo" style="color:green" ></asp:Label>
                </div>
                ...
                <div class="form-group">
                    <asp:Label runat="server" id="L_cuenta" style="color:green" ></asp:Label>
                </div>
