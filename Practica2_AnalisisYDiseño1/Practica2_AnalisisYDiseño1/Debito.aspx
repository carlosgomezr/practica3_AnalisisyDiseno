<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Debito.aspx.cs" Inherits="Practica2_AnalisisYDiseño1.Debito" %>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="Debito.aspx">DEBITO</a></li>
        ...
        <div class="container">
            <form id="form1" runat="server" class="center" role="form">
                ...
                <div class="form-group">
                    <asp:Label runat="server" >Cuenta A Debitar</asp:Label>                                    
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <asp:Label runat="server" >Monto a Debitar</asp:Label>                                    
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <asp:Button ID="b_agua" value="1" name="b_ingresar" type="Button" class="btn btn-success btn-md btn-block" runat="server" Text="DEBITAR" OnClick="b_agua_Click"   />
