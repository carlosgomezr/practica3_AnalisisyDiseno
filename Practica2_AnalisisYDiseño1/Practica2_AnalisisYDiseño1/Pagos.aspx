<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pagos.aspx.cs" Inherits="Practica2_AnalisisYDiseño1.Pagos" %>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="Transferencias.aspx">TRANSFERENCIAS</a></li>
                    <li class="active"><a href="Pagos.aspx">PAGO SERVICIOS</a></li>
    ...
    <section id="title" class="emerald">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h1>PAGOS</h1>
                    <p>REALIZA EL PAGO DE CUALQUIER SERVICIO </p>
        ...
        <div class="container">
            <form id="form1" runat="server" class="center" role="form">
                ...
                <div class="form-group">
                    <asp:Label runat="server" >Cuenta del Servicio</asp:Label>                                    
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <asp:Button ID="b_agua" value="1" name="b_ingresar" type="Button" class="btn btn-success btn-md btn-block" runat="server" Text="AGUA" OnClick="b_agua_Click" />
                     <asp:Button ID="b_telefono" value="3" name="b_ingresar" type="Button" class="btn btn-success btn-md btn-block" runat="server" Text="TELEFONO" OnClick="b_telefono_Click" />
                     <asp:Button ID="b_luz" value="2" name="b_ingresar" type="Button" class="btn btn-success btn-md btn-block" runat="server" Text="LUZ" OnClick="b_luz_Click" />
                     <asp:Button ID="b_colegio" value="4" name="b_ingresar" type="Button" class="btn btn-success btn-md btn-block" runat="server" Text="COLEGIO" OnClick="b_colegio_Click" />
