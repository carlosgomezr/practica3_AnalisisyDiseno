<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Saldo.aspx.cs" Inherits="Practica2_AnalisisYDiseño1.Saldo" %>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="Saldo.aspx">MI SALDO</a></li>
    ...
    <section id="recent-works">
        <div class="container">
            <form id="form1" runat="server" class="center" role="form">
                ...
                <div class="form-group">
                    <asp:Label runat="server" id="L_saldo"></asp:Label>                                     
                </div>
