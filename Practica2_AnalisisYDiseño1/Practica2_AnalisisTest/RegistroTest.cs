...
namespace Practica2_AnalisisyDiseño1.Tests
{
    ...
    public class RegistroTest
    {
        ...
        public void RegistroUsuario()
        {
            ...
            const String nombre = "Mario"; //nombre completo del usuario
            const String nombreUsuario = "Marioxd"; //nickname del usuario
            const String correo = "mario@gmail.com"; //correo electronico del usuario
